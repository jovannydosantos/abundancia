 ...
 *
 */
class GarnishesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'garnish' => ['type' => 'string', 'length' => 64, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish2_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'garnish' => 'Lorem ipsum dolor sit amet',
                'status' => 1,
                'price' => 1.5,
                'created' => '2018-07-24',
                'modified' => '2018-07-24'
