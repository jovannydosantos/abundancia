...
<div class="foodTypes index large-9 medium-8 columns content">
    <h3><?= __('Food Types') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $foodType->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $foodType->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $foodType->id], ['confirm' => __('Are you sure you want to delete # {0}?', $foodType->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
