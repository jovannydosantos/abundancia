 ...
 * @property \App\Model\Table\PackageOrdersTable|\Cake\ORM\Association\BelongsTo $PackageOrders
...
class PaymentsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('type_order')
            ->requirePresence('type_order', 'create')
            ->notEmpty('type_order');
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['package_order_id'], 'PackageOrders'));
